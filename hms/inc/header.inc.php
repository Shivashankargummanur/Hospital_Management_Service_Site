...
<nav role="navigation" class="navbar navbar-default real-nav" >
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand"><img src='images/images.jpg' class='img-responsive img-logo' style="height: 100px;width:400px; margin-bottom: 1000px;margin-top:0px;margin-left:500px;" /></a>
        </div>
